...
/*   Updated: 2020/07/01 09:54:08 by lravier       ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void				add_to_visited(t_room *curr, uint64_t *visited);
...
// BITFIELD-TOOLKIT:
void				add_bite_conj(t_room *dst, t_room *conj);
...
int					check_appropriate(t_room *src, t_subpath *pt, t_room *nb);
...
// Route finding
int				has_only_sp_from_src(t_room *src, t_room *dst,
t_subpath *candidate);
size_t		add_to_this_conj_path(t_queue *item, t_room *dst, t_room *src,
t_subpath *pt, t_map *map);
size_t				add_nodes_to_path(t_queue *item, t_subpath **path, t_map *map, 
int *add);
size_t				find_routes(t_map *map);
size_t				setup_paths(t_map *map);
size_t				new_subpath(t_subpath **pt, t_room *conj, t_map *map);
t_room				**new_path(size_t size);
// size_t				add_subpath(t_queue *item, t_subpath **path, t_map *map);
// size_t				add_subpath(t_room *src, t_room *dst, t_subpath **pt, t_map *map);
// ssize_t				add_subpath(t_room *src, t_room *dst, t_subpath **pt, t_map *map);
size_t				add_path(t_qwrap *qr, t_queue *item, t_subpath *path, t_map *map);
size_t				add_new_conj_path(t_queue *queue, t_room *dst, t_room *src, t_subpath *path, t_map *map);
size_t				add_to_conj_path(t_queue *queue, t_room *dst, t_room *src,
					t_subpath *pt, t_map *map);
// int					has_path_to_conj(t_room *curr, t_room *conj);
// size_t				is_new_conj(t_room *src, t_room *curr, t_subpath *spt);
int					has_path_to_conj(t_room *curr, t_room *conj);
// Path building
